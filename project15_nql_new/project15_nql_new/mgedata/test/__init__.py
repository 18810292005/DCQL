...
from apps.storage.models import MaterialProject, MaterialCategory, MaterialMethod, DataMeta
...
def material_category_required(func):
    ...
    def inner(test_case, *args, **kwargs):
        create_material_category_tree(MaterialCategory, test_case.material_categories_to_create())
...
def template_required(func):
    ...
    def inner(self):
        ...
        self.material_category_id: int = MaterialCategory.objects.get(name_zh='leaf').id
