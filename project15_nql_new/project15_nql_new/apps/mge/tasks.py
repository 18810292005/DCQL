...
from apps.analytics.models import ClassCounter, SubjectCounter, ClassTrend, SubjectTrend, ProjectTrend
...
from apps.storage.models import MaterialCategory, Template, DataMeta, MaterialSubject, MaterialProject
...
def beat_per_day():
    ...
    classes = MaterialCategory.objects.filter(leaf=True)
    for c in classes:
