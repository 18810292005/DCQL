...
from apps.storage.models import Template, MaterialCategory, MaterialProject
...
class TestDbToDataContent(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.category_root = MaterialCategory.objects.create(leaf=False, level=0, name_zh='root', name_en='root')
        self.category = MaterialCategory.objects.create(parent=self.category_root,
                                                        level=1,
                                                        name_zh='leaf',
                                                        name_en='leaf',
                                                        leaf=True)
