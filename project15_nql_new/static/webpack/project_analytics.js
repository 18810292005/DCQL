...
module.exports = __webpack_require__.p + "img/unaccepted.png";
...
var style = __webpack_require__(709);
...
// CONCATENATED MODULE: ./apis/project/ProjectAnalytics.ts
...
function _GetProjectList() {
  _GetProjectList = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt("return", Object(Fetch["k" /* default */])(Urls["b" /* default */].api_v1_1_storage.project_all));
...
function Transform(raw, id) {
  var classList = raw.categories ? raw.categories.map(function (value) {
    return {
      name: value.name,
      id: value.id,
...
function GetProjectAnalytics(_x, _x2) {
  return _GetProjectAnalytics.apply(this, arguments);
}

function _GetProjectAnalytics() {
  _GetProjectAnalytics = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(projectID, end) {
    var beg,
        subjectID,
        parameters,
        url,
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            beg = _args2.length > 2 && _args2[2] !== undefined ? _args2[2] : 201901;
            subjectID = _args2.length > 3 ? _args2[3] : undefined;
            parameters = "beg=" + beg + "&end=" + end;
            url = '';

            if (subjectID) {
              url = "".concat(Urls["b" /* default */].api_v1_1_storage.get_subject_analytics(projectID, subjectID), "?").concat(parameters);
            } else {
              url = "".concat(Urls["b" /* default */].api_v1_1_storage.get_project_analytics(projectID), "?").concat(parameters);
            }
          ...
          case 7:
            ...
            return _context2.abrupt("return", Transform(result, subjectID ? subjectID : projectID));
...
// CONCATENATED MODULE: ./apis/project/AnalyticsOverview.ts


function ProjectAnalytisOverview() {
  var url = Urls["b" /* default */].api_v1_1_storage.projects_analytics_info;
  var result = Object(Fetch["k" /* default */])(url);
  return result;
}
...
// EXTERNAL MODULE: ./img/accepted.png
var accepted = __webpack_require__(716);
var accepted_default = /*#__PURE__*/__webpack_require__.n(accepted);

// EXTERNAL MODULE: ./img/unaccepted.png
var unaccepted = __webpack_require__(1114);
var unaccepted_default = /*#__PURE__*/__webpack_require__.n(unaccepted);
...
// CONCATENATED MODULE: ./components/pages/ProjectAnalyticsDisplay.tsx
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var ProjectAnalyticsDisplay_ProjectAnalyticsDisplay = /*#__PURE__*/function (_Component) {
  _inherits(ProjectAnalyticsDisplay, _Component);

  var _super = _createSuper(ProjectAnalyticsDisplay);

  function ProjectAnalyticsDisplay(props) {
    var _this;

    _classCallCheck(this, ProjectAnalyticsDisplay);
  ...
  _createClass(ProjectAnalyticsDisplay, [{
    ...
    value: function componentDidMount() {
      ...
      ProjectAnalytisOverview().then(function (value) {
        _this2.setState({
          overview: value,
          table: false
        });
    ...
    key: "getAnalytics",
    value: function getAnalytics(id, end_time) {
      var _this3 = this;

      var isSubject = Number(id[id.length - 1]) | Number(id[id.length - 2]);

      if (isSubject) {
        var subject_id = id.slice(0, id.length - 2) + "00";
        GetProjectAnalytics(subject_id, end_time, end_time - 100, id).then(function (value) {
          if (_this3.props.id === value.id) {
            _this3.setState({
              loading: false,
        ...
        GetProjectAnalytics(id, end_time, end_time - 100).then(function (value) {
          if (_this3.props.id === value.id) {
            _this3.setState({
              loading: false,
              dataCount: value.data_count,
    ...
    value: function fetchData(id, global) {
      ...
      global ? Object(Get["b" /* GetGlobalAnalytics */])().then(function (value) {
        if (_this4.props.id === 'all') {
          _this4.setState({
            loading: false,
    ...
    value: function onItemClick(key) {
      ...
      window.open(Urls["b" /* default */].search.index + "?q=".concat(Object(Base64["b" /* Encode */])(qStr)));
    }
  }, {
    key: "onSearchClick",
    value: function onSearchClick(text) {
      ...
      Object(Query["b" /* CreateFullTextQuery */])(text).then(this.handleResult);
    }
  }, {
    key: "ItemToDiv",
    value: function ItemToDiv(item, onItemClick) {
    ...
    value: function render() {
      ...
      var relatedRow = null;
      var overview = null;
      var msg = this.state.ac_status === '通过' ? '验收通过' : this.state.ac_status;
      infoRow = /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(row_default.a, {
        ...
        className: 'DataCard__content__title'
      }, Object(Text["a" /* TEXT */])("dash:ps_name", "项目/课题名称")), /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement("a", {
        style: {
          fontSize: 'x-large',
          fontWeight: 500
        },
        onClick: function onClick() {
          _this5.onSearchClick(_this5.props.id);
        }
      }, this.props.name, "(", msg, ")"))), /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(col_default.a, {
        xs: 24,
        sm: 12
      }, /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(card_default.a, {
        style: {
        ...
        className: 'DataCard__content__title'
      }, Object(Text["a" /* TEXT */])("dash:ps_id", "项目/课题编号")), /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement("a", {
        style: {
          fontSize: 'x-large',
          fontWeight: 500
        },
      ...
      graphRow = /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement("div", null, /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(row_default.a, null, /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(col_default.a, {
        xs: 24,
        lg: 12
      ...
      /*#__PURE__*/
      //全站统计页面显示趋势图
      reactfrom_dll_reference_dll_library_default.a.createElement(TitledCard["a" /* TitledCard */], {
        title: /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(index_es["a" /* FormattedMessage */], {
          id: 'analytics:trend_graph',
          defaultMessage: "\u8D8B\u52BF\u56FE"
        })
      ...
      reactfrom_dll_reference_dll_library_default.a.createElement(TitledCard["a" /* TitledCard */], {
      ...
      })))), this.props.global ? /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement("div", null, /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(row_default.a, null, /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(col_default.a, {
        xs: 24,
        md: 12,
        lg: 6
      }, /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(TitledCard["a" /* TitledCard */], {
        title: /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(index_es["a" /* FormattedMessage */], {
          id: 'analytics:2016 Project Acceptance Chart',
          defaultMessage: "16\u5E74\u7ACB\u9879\u9879\u76EE\u9A8C\u6536\u60C5\u51B5"
        })
      }, /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(MgeCarousel["b" /* MgeCarousel */], {
        trendData: this.state.trendData,
        categoryData: this.state.categoryData,
        PieData: this.state.acceptance[2016],
        loading: this.state.loading,
        graphType: MgeCarousel["a" /* GraphType */].Pie,
        showType: MgeCarousel["c" /* ShowType */].All
      }))), /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(col_default.a, {
        xs: 24,
        md: 12,
        ...
        title: /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(index_es["a" /* FormattedMessage */], {
          id: 'analytics:2017 Project Acceptance Chart',
          defaultMessage: "17\u5E74\u7ACB\u9879\u9879\u76EE\u9A8C\u6536\u60C5\u51B5"
        })
      }, /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(MgeCarousel["b" /* MgeCarousel */], {
        trendData: this.state.trendData,
        categoryData: this.state.categoryData,
        PieData: this.state.acceptance[2017],
        loading: this.state.loading,
        graphType: MgeCarousel["a" /* GraphType */].Pie,
        showType: MgeCarousel["c" /* ShowType */].All
      }))), /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(col_default.a, {
        ...
        title: /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(index_es["a" /* FormattedMessage */], {
          id: 'analytics:2018 Project Acceptance Chart',
          defaultMessage: "18\u5E74\u7ACB\u9879\u9879\u76EE\u9A8C\u6536\u60C5\u51B5"
        })
      }, /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(MgeCarousel["b" /* MgeCarousel */], {
        trendData: this.state.trendData,
        categoryData: this.state.categoryData,
        PieData: this.state.acceptance[2018],
        loading: this.state.loading,
        graphType: MgeCarousel["a" /* GraphType */].Pie,
        showType: MgeCarousel["c" /* ShowType */].All
      }))), /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(col_default.a, {
        ...
        title: /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(index_es["a" /* FormattedMessage */], {
          id: 'analytics:All Project Acceptance Chart',
          defaultMessage: "\u6240\u6709\u9879\u76EE\u9A8C\u6536\u60C5\u51B5"
        })
      }, /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(MgeCarousel["b" /* MgeCarousel */], {
        trendData: this.state.trendData,
        categoryData: this.state.categoryData,
        PieData: this.state.acceptance['total'],
        loading: this.state.loading,
        graphType: MgeCarousel["a" /* GraphType */].Pie,
        showType: MgeCarousel["c" /* ShowType */].All
        ...
        title: /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(index_es["a" /* FormattedMessage */], {
          id: 'analytics:Quantity statistics of remittance items',
          defaultMessage: "\u5F00\u59CB\u6C47\u4EA4\u9879\u76EE\u6570\u91CF\u7EDF\u8BA1"
        })
      }, /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(MgeCarousel["b" /* MgeCarousel */], {
        trendData: this.state.trendData,
        categoryData: this.state.categoryData,
        ProjectData: this.state.uploadTime,
        loading: this.state.loading,
        graphType: MgeCarousel["a" /* GraphType */].Statistics,
        showType: MgeCarousel["c" /* ShowType */].Project,
        showXUnit: true,
        showUnit: false
      }))), /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(col_default.a, {
        xs: 24,
        ...
        title: /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(index_es["a" /* FormattedMessage */], {
          id: 'analytics:Quantity statistics of acceptance items',
          defaultMessage: "\u5F00\u59CB\u9A8C\u6536\u9879\u76EE\u6570\u91CF\u7EDF\u8BA1"
        })
      }, /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(MgeCarousel["b" /* MgeCarousel */], {
        trendData: this.state.trendData,
        categoryData: this.state.categoryData,
        ProjectData: this.state.applyCount,
        loading: this.state.loading,
        graphType: MgeCarousel["a" /* GraphType */].Statistics,
        showType: MgeCarousel["c" /* ShowType */].Project,
        showXUnit: true,
        ...
        title: /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(index_es["a" /* FormattedMessage */], {
          id: 'analytics:Quantity statistics of remittance data',
          defaultMessage: "\u9879\u76EE\u6C47\u4EA4\u6570\u636E\u5206\u5E03\u7EDF\u8BA1"
        })
      }, /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(MgeCarousel["b" /* MgeCarousel */], {
        trendData: this.state.trendData,
        categoryData: this.state.categoryData,
        ProjectData: this.state.distribution,
        loading: this.state.loading,
        graphType: MgeCarousel["a" /* GraphType */].Statistics,
        showType: MgeCarousel["c" /* ShowType */].Project,
        showXUnit: false,
      ...
      relatedRow = /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(row_default.a, null, /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(col_default.a, {
        xs: 24,
        xl: 12
      }, /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(TitledCard["a" /* TitledCard */], {
        title: /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(index_es["a" /* FormattedMessage */], {
      ...
      }, this.state.loading ? /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement("div", {
        style: {
          display: "flex",
          width: "100%",
          flexDirection: "column",
      ...
      }, /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(spin_default.a, null)) : this.state.relatedTemplate.map(function (value) {
        return _this5.ItemToDiv(value, _this5.onItemClick);
      })))), /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(col_default.a, {
        xs: 24,
        xl: 12
      }, /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(TitledCard["a" /* TitledCard */], {
      ...
      }, /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(spin_default.a, null)) : this.state.relatedCategory.map(function (value) {
        return _this5.ItemToDiv(value, _this5.onItemClick);
      })))));
      overview = this.state.isLeader ? /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(TitledCard["a" /* TitledCard */], {
        title: /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(index_es["a" /* FormattedMessage */], {
          id: 'analytics:global',
          defaultMessage: "\u5168\u5C40\u7EDF\u8BA1"
        })
      ...
      }, /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(spin_default.a, null)) : /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(table_default.a, {
        dataSource: this.state.overview,
        loading: this.state.table,
        ...
        title: Object(Text["a" /* TEXT */])('project_id', '项目编号'),
        key: 'id',
        dataIndex: 'id',
        width: '20%',
        render: function render(text) {
          return /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement("a", {
            onClick: function onClick() {
              _this5.onSearchClick(text);
            }
          }, text);
        }
      }), /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(Column, {
        title: Object(Text["a" /* TEXT */])('name', '项目名称'),
        key: 'name',
        dataIndex: 'name',
        width: '35%',
        render: function render(text, record) {
          return /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement("a", {
            onClick: function onClick() {
              _this5.onSearchClick(record.id);
            }
          }, text);
        }
      }), /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(Column, {
        title: Object(Text["a" /* TEXT */])('leader', '项目负责人'),
        key: 'leader',
        dataIndex: 'leader',
        width: '10%'
      }), /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(Column, {
        title: Object(Text["a" /* TEXT */])('analytics:data_count', '汇交条数'),
        key: 'data_count',
        dataIndex: 'data_count',
        width: '10%'
      }), /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(Column, {
        title: Object(Text["a" /* TEXT */])('analytics:template_count', '汇交模板数'),
        key: 'tem_count',
        dataIndex: 'tem_count',
        width: '10%'
      })))) : null;
      ...
      }), this.props.global ? /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(row_default.a, null, /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(col_default.a, {
        xs: 24,
        xl: 12
      }, /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(DataCard["a" /* DataCard */], {
        icon: accepted_default.a,
        value: this.state.acceptance.total[0],
        loading: this.state.loading,
        title: /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(index_es["a" /* FormattedMessage */], {
          id: 'analytics:accepted_items',
          defaultMessage: "\u5DF2\u9A8C\u6536\u9879\u76EE\u6570"
        })
      })), /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(col_default.a, {
        xs: 24,
        xl: 12
      }, /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(DataCard["a" /* DataCard */], {
        icon: unaccepted_default.a,
        value: this.state.acceptance.total[1],
        loading: this.state.loading,
        title: /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(index_es["a" /* FormattedMessage */], {
          id: 'analytics:items to be accepted',
          defaultMessage: "\u672A\u9A8C\u6536\u9879\u76EE\u6570"
        })
      }))) : infoRow, /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(row_default.a, null, /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(col_default.a, {
        xs: 24,
        xl: 12
      }, /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(DataCard["a" /* DataCard */], {
      ...
      }))), graphRow, this.props.global ? overview : relatedRow);
    }
  }]);

  return ProjectAnalyticsDisplay;
}(reactfrom_dll_reference_dll_library["Component"]);

Object(tslib_es6["a" /* __decorate */])([core_decorators["a" /* autobind */]], ProjectAnalyticsDisplay_ProjectAnalyticsDisplay.prototype, "fetchData", null);
...
var lib_tree = __webpack_require__(109);
var tree_default = /*#__PURE__*/__webpack_require__.n(lib_tree);

// CONCATENATED MODULE: ./apis/project/GetSpecificProject.ts
function GetSpecificProject_asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }

function GetSpecificProject_asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { GetSpecificProject_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { GetSpecificProject_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }



function GetSpecificProject(_x) {
  return _GetSpecificProject.apply(this, arguments);
}

function _GetSpecificProject() {
  _GetSpecificProject = GetSpecificProject_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(id) {
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt("return", Object(Fetch["k" /* default */])(Urls["b" /* default */].api_v1_1_storage.specific_material_project(id)));
...
// CONCATENATED MODULE: ./components/project/ProjectTree.tsx
function ProjectTree_typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { ProjectTree_typeof = function _typeof(obj) { return typeof obj; }; } else { ProjectTree_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return ProjectTree_typeof(obj); }
...
function ProjectTree_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function ProjectTree_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function ProjectTree_createClass(Constructor, protoProps, staticProps) { if (protoProps) ProjectTree_defineProperties(Constructor.prototype, protoProps); if (staticProps) ProjectTree_defineProperties(Constructor, staticProps); return Constructor; }

function ProjectTree_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) ProjectTree_setPrototypeOf(subClass, superClass); }

function ProjectTree_setPrototypeOf(o, p) { ProjectTree_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return ProjectTree_setPrototypeOf(o, p); }

function ProjectTree_createSuper(Derived) { var hasNativeReflectConstruct = ProjectTree_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = ProjectTree_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = ProjectTree_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return ProjectTree_possibleConstructorReturn(this, result); }; }

function ProjectTree_possibleConstructorReturn(self, call) { if (call && (ProjectTree_typeof(call) === "object" || typeof call === "function")) { return call; } return ProjectTree_assertThisInitialized(self); }

function ProjectTree_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function ProjectTree_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }

function ProjectTree_getPrototypeOf(o) { ProjectTree_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return ProjectTree_getPrototypeOf(o); }




var TreeNode = tree_default.a.TreeNode;
var ProjectTree_ProjectTree = /*#__PURE__*/function (_Component) {
  ProjectTree_inherits(ProjectTree, _Component);

  var _super = ProjectTree_createSuper(ProjectTree);

  function ProjectTree(props) {
    var _this;

    ProjectTree_classCallCheck(this, ProjectTree);
    ...
    _this.onLoadData = function (treeNode) {
      return new Promise(function (resolve) {
        ...
        GetSpecificProject(treeNode.props.dataRef.title).then(function (value) {
          value.subjects.map(function (item) {
            childern.push({
              title: item.id,
              key: item.name,
              isLeaf: true
      ...
      return data.map(function (item) {
        if (item.children) {
          return /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(TreeNode, {
            ...
            }, _this.props.display == 'name' ? item.key : item.title),
            key: item.key,
            dataRef: item
    ...
    _this.selectNode = function (key, e) {
      _this.props.onClick(e.node.props.dataRef.title, e.node.props.eventKey);
    };
  ...
  ProjectTree_createClass(ProjectTree, [{
    key: "componentWillMount",
    value: function componentWillMount() {
      var _this2 = this;

      var tree = [];
      GetProjectList().then(function (value) {
    ...
    key: "render",
    value: function render() {
      return /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(tree_default.a, {
...
// CONCATENATED MODULE: ./entry/project_analytics.tsx
function project_analytics_typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { project_analytics_typeof = function _typeof(obj) { return typeof obj; }; } else { project_analytics_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return project_analytics_typeof(obj); }




function project_analytics_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function project_analytics_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function project_analytics_createClass(Constructor, protoProps, staticProps) { if (protoProps) project_analytics_defineProperties(Constructor.prototype, protoProps); if (staticProps) project_analytics_defineProperties(Constructor, staticProps); return Constructor; }

function project_analytics_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) project_analytics_setPrototypeOf(subClass, superClass); }

function project_analytics_setPrototypeOf(o, p) { project_analytics_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return project_analytics_setPrototypeOf(o, p); }

function project_analytics_createSuper(Derived) { var hasNativeReflectConstruct = project_analytics_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = project_analytics_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = project_analytics_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return project_analytics_possibleConstructorReturn(this, result); }; }

function project_analytics_possibleConstructorReturn(self, call) { if (call && (project_analytics_typeof(call) === "object" || typeof call === "function")) { return call; } return project_analytics_assertThisInitialized(self); }

function project_analytics_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function project_analytics_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }

function project_analytics_getPrototypeOf(o) { project_analytics_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return project_analytics_getPrototypeOf(o); }
...
var project_analytics_CategoryBlock = /*#__PURE__*/function (_Component) {
  project_analytics_inherits(CategoryBlock, _Component);

  var _super = project_analytics_createSuper(CategoryBlock);

  function CategoryBlock() {
    project_analytics_classCallCheck(this, CategoryBlock);

    return _super.apply(this, arguments);
  }

  project_analytics_createClass(CategoryBlock, [{
    key: "render",
    value: function render() {
      return /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement("div", {
...
var project_analytics_AnalyticsEntry = /*#__PURE__*/function (_Component2) {
  project_analytics_inherits(AnalyticsEntry, _Component2);

  var _super2 = project_analytics_createSuper(AnalyticsEntry);

  function AnalyticsEntry(props) {
    var _this;

    project_analytics_classCallCheck(this, AnalyticsEntry);
  ...
  project_analytics_createClass(AnalyticsEntry, [{
    key: "handleSwitchProject",
    value: function handleSwitchProject(key, name) {
      this.setState({
        selected: key,
        name: name
      });
    ...
    key: "changeDisplay",
    value: function changeDisplay(checked) {
      if (checked) {
        this.setState({
          display: 'name'
        });
    ...
    value: function render() {
      ...
      }, /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(project_analytics_CategoryBlock, {
        selected: this.state.selected === 'all',
        onClick: function onClick() {
          return _this2.handleSwitchProject('all', globalText);
        },
        style: {
      ...
      }, /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(ProjectTree_ProjectTree, {
        className: 'tree-wrapper',
        display: this.state.display,
        onClick: this.handleSwitchProject
      }))), /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement("div", {
        className: 'analytics__content'
      }, /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(ProjectAnalyticsDisplay_ProjectAnalyticsDisplay, {
        global: this.state.selected === 'all',
...
Object(tslib_es6["a" /* __decorate */])([core_decorators["a" /* autobind */]], project_analytics_AnalyticsEntry.prototype, "handleSwitchProject", null);

Object(tslib_es6["a" /* __decorate */])([core_decorators["a" /* autobind */]], project_analytics_AnalyticsEntry.prototype, "changeDisplay", null);

react_domfrom_dll_reference_dll_library_default.a.render( /*#__PURE__*/reactfrom_dll_reference_dll_library_default.a.createElement(project_analytics_AnalyticsEntry, null), document.getElementById('wrap'));
