...
class TemplateContentToEsMapping:
    ...
    default_fields = ('title', 'doi', 'keywords', 'abstract', 'purpose',
                      'contributor', 'source', 'methods', 'reference',
                      'project', 'subject', 'category_name', 'template_name',
                      'user', 'realname', 'institution', 'reviewer_realname',
                      'reviewer_institution', 'review_state',
                      'disapprove_reason', 'summary')
    long_fields = ('id', 'category', 'template', 'downloads', 'views')
    boolean_fields = ('importing', 'is_public')
    double_fields = ('score', )
    keyword_fields = ('public_range', 'reviewer', 'external_link')
    date_fields = ('public_date', 'add_time', 'last_modified')
