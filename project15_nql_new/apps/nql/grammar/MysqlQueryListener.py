...
class MysqlQueryListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by MysqlQueryParser#tableName.
    def enterTableName(self, ctx:MysqlQueryParser.TableNameContext):
        pass

    # Exit a parse tree produced by MysqlQueryParser#tableName.
    def exitTableName(self, ctx:MysqlQueryParser.TableNameContext):
        pass
