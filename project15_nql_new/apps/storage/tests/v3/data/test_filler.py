...
from apps.storage.models import Template, MaterialCategory
...
class TestDataRandomFiller(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.category_root = MaterialCategory.objects.create(leaf=False, level=1, name_zh='root', name_en='root')
