...
def notify_admins(admin_type: UserRole, n_type: NotificationType, object1=None, object2=None, object3=None,
                  via_email=False):
    admins = User.filter_with_role(admin_type)
    notify(admins, n_type, object1, object2, object3)
    if via_email:
        pass
