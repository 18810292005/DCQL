...
class Notification(models.Model):
    ...
    def to_string(self):
        ...
        return _notification_map[self.notification_type].html % {'object1': ugettext(self.object1 or ""),
                                                                 'object2': ugettext(self.object2 or ""),
                                                                 'object3': ugettext(self.object3 or "")}
