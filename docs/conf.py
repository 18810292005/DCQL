...
latex_documents = [
    (master_doc, 'mgedata.tex', 'mgedata Documentation',
     'micl', 'manual'),
]
...
man_pages = [
    (master_doc, 'mgedata', 'mgedata Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'mgedata', 'mgedata Documentation',
     author, 'mgedata', 'One line description of project.',
     'Miscellaneous'),
]
